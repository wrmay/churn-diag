...
public class CustomerUsageDetails implements Serializable,CacheItem {
	...
	public static String createKey(String areaCode, String num) {
		return areaCode + "-" + num;
	}
	
	private String calculateKey(){
		key = CustomerUsageDetails.createKey(this.areaCode, this.phone);
		return key;
	}
